                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="muted">
                                <?php if ($p['phone']): ?>
                                <!-- Phone stored as E.164 (+92300...) — wa.me wants digits only. Visited today →
                                     chat pre-filled with the thank-you message; otherwise the chat opens empty. -->
                                <?php $waText = ($p['last_visit'] === date('Y-m-d')) ? '?text=' . rawurlencode('Thank You for Visiting BabyMedics!') : ''; ?>
                                <a class="wa-link" href="https://wa.me/<?= preg_replace('/\D/', '', $p['phone']) ?><?= $waText ?>" target="_blank" rel="noopener" title="Message on WhatsApp">
