                        ...
                        <div class="qrow">
                            ...
                            <div class="c-patient">
                                ...
                                <div class="qmeta"><span class="mono"><?= htmlspecialchars($row['mrn']) ?></span> &middot; <?= $ageDisplay ?> &middot;
                                    ...
                                    <a class="wa-link" href="https://wa.me/<?= preg_replace('/\D/', '', $row['phone']) ?>?text=<?= rawurlencode('Thank You for Visiting Smile Resort!') ?>" target="_blank" rel="noopener" title="Send thank-you on WhatsApp">
