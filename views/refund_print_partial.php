...
$uc = fn($s) => $s !== null && $s !== '' ? mb_strtoupper($s, 'UTF-8') : $s;
$patientNameUpper = $uc($refund['patient_name']);
$fatherNameUpper = $refund['father_name'] ? $uc($refund['father_name']) : '—';
$doctorNameUpper = $uc($refund['doctor_name']);
$approvedByUpper = $uc($refund['approved_by_name']);
$generatedByUpper = $uc($refund['generated_by_name']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="invoice-container">
        ...
        <table class="metadata-table">
            ...
            <tr><td><strong>Name:</strong></td><td><?= htmlspecialchars($patientNameUpper) ?></td></tr>
            <tr><td><strong>S/D/W Of:</strong></td><td><?= htmlspecialchars($fatherNameUpper) ?></td></tr>
            <tr><td><strong>DOB:</strong></td><td><?= $patientDobDisplay ?></td></tr>
            <tr><td><strong>Doctor:</strong></td><td><?= htmlspecialchars($doctorNameUpper) ?></td></tr>
        ...
        <div class="signatures">
            <div class="sig">
                ...
                <div class="nm"><?= htmlspecialchars($approvedByUpper) ?></div>
            </div>
            <div class="sig">
                <div class="line"></div>
                <div class="role">GENERATED BY</div>
                <div class="nm"><?= htmlspecialchars($generatedByUpper) ?></div>
            </div>
            <div class="sig">
                <div class="line"></div>
        ...
        <div class="footer">
            ...
            <span>Front Desk: <?= htmlspecialchars($generatedByUpper) ?></span>
        </div>
